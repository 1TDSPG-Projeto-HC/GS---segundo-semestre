  ...
  return (
    <div className="card">
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
        Escolha um número de 1 (pior) a 5 (melhor) e deixe um comentário opcional.
      </p>
      ...
      <textarea
        ...
        className="w-full p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-transparent mb-4 focus:ring-2 focus:ring-indigo-500 outline-none"
